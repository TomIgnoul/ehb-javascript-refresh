...
let regel = [];
let deelbaar1 = parseFloat(await userInput.question(`Moet getal deelbaar zijn door deler1? `))
let deelbaar2 = parseFloat(await userInput.question(`Moet getal deelbaar zijn door deler2? `))
